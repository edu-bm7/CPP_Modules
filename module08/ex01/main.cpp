...
static void testNegativeSpan()
{
...

	{
		...
		std::cout << "Negative Span: \n"
				  << negative_span << std::endl;
		std::cout << "shortest span: \n"
				  << negative_span.shortestSpan() << std::endl;
		std::cout << "longest span: \n"
				  << negative_span.longestSpan() << std::endl;
	}
	std::cout << std::endl;
	{
		Span negative_span(5);
...
static void testSmallSpan()
{
...

	{
		...
		std::cout << "Small Span: \n"
				  << small_span << std::endl;
		std::cout << "shortest span: \n"
				  << small_span.shortestSpan() << std::endl;
		std::cout << "longest span: \n"
				  << small_span.longestSpan() << std::endl;
	}
	std::cout << std::endl;
	{
		Span small_span(5);
...
static void testBigSpan()
{
...

	{
		...
		std::cout << "MIN_NUMBER: \n"
				  << *std::min_element(vec.begin(), vec.end()) << std::endl;

		std::cout << "shortest span: \n"
				  << big_span.shortestSpan() << std::endl;
		std::cout << "longest span: \n"
				  << big_span.longestSpan() << std::endl;
	}
	{
